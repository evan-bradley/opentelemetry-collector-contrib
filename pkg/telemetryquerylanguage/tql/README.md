...
Slices are sequences containing elements of a single type, and can support any type supported when passing a single value.

Example slices
- `["one", "two", "three"]`
- `[1, 2, 3]`
- `[attributes["one"], attributes["two"], attributes["three"]]`
